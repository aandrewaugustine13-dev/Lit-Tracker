    ...
    >
      ...
      <div className="aspect-[3/4] bg-stone-100 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-1">
          <button onClick={handleChat} title="Interview" className="p-2 bg-ember-600 hover:bg-ember-500 text-white rounded-lg border border-ember-500 transition-colors">
            <MessageSquare size={13} />
          </button>
          <button onClick={handleEdit} className="p-2 bg-white hover:bg-stone-50 text-stone-600 rounded-lg border border-stone-300 transition-colors">
            <Edit3 size={13} />
          </button>
          <button onClick={handleDelete} className="p-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg border border-red-200 transition-colors">
            <Trash2 size={13} />
          </button>
        </div>
      </div>
